...
void main(){
  ...
  test("Non-empty starting date field returns error string", () {
    var result = HelpValidator.validateExpectedDate("2022-10-10 00:00:00.000", "");
    expect(result, "Starting date cannot be empty");
  });

  test("Future expected date for starting date returns error string", () {
    var result = HelpValidator.validateExpectedDate("2022-10-10 00:00:00.000", "2022-10-12 00:00:00.000");
    expect(result, "Invalid Date");
  });

  test("Future expected date for starting date returns error string", () {
    var result = HelpValidator.validateExpectedDate("2022-12-10 00:00:00.000", "2022-10-12 00:00:00.000");
